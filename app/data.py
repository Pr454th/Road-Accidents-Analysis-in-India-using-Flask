...
Original file is located at
    https://colab.research.google.com/drive/1zLBk1fnoWie9dw6le2zkVTxcBeFsNr_g

# Introduction
 
 
**“India tops the world with 11% of global death in road accidents.
It has 1 per cent of the world's vehicles but accounts for 11 per cent of all road crash deaths, witnessing 53 road crashes every hour; killing 1 person every 4 minutes” – World Bank Report**
*-The Economic Times, Feb 14, 2021*

![ROAD_ACCIDENTS_570_850.jpg](attachment:2e25871d-200d-4e92-b690-f4b84c57c676.jpg)

This is indeed an alarming report. With the rapid increase in the number of automobiles and also the heavily congested roads, ensuring road safety has utmost importance for the people in the country.
Fatalities and injuries resulting from road traffic accidents can create a heavy burden on the economy and can strain the health, insurance and legal systems of the country.
 
India has recorded a significant drop in road crashes and deaths in 2020 when compared to 2019. This is partly due to COVID-19 pandemic-prompted lockdowns and people voluntarily not venturing out to prevent transmission. Hence to get a better view, a detailed analysis was carried out to understand some of the major reasons for the high accident cases in India using the data from  2017-2019. The source of this data is the official website of Government of India (https://data.gov.in/  ).
"""
...
"""# Read Relevant Datasets for the Analysis"""
...
def main(Y2019_death_data,Y2018_death_data,Y2017_death_data,drunk_data,Cause_2019,Cause_2018,Cause_2017,Mode_2019,Mode_2018,Mode_2017,two_wheel_combined,time_3_yrs):
    ...
    Studies states that each year, about three to five percent of the country’s GDP was invested in road accidents. Notably, while India has about one percent of the world’s vehicle population, it also accounted for about six percent of the global road traffic incidents.

    (source:https://www.statista.com/statistics/746887/india-number-of-fatalities-in-road-accidents/#:~:text=Road%20accidents%20have%20been%20a,was%20invested%20in%20road%20accidents.)
    """
    ...
    # Some Factors Affecting The High Number Of Road Accidents In The Country

    Below points were considered to understand the reasons for high number of road accident cases :-

    1. Cause-wise Analysis
    2. Analysis based on mode of transport
    3. Analysis based on the time of Occurence
    """
    ...
    **Driving under the influence of Drug/Alchohol is also another cause affecting the number of accidents.
    A further analysis was carried out on this factor to get a better insight.**
    """
    ...
    **Accidents in UP due to this factor has only increased over 3 years.**

    **Andhra Pradesh shows very good improvement and the number of accident cases due to drinking and driving has reduced considerably.**
    """
    ...
    Road traffic accidents (RTAs) have become an important public health issue.
    This needs to be tackled by a multi-disciplinary approach.
